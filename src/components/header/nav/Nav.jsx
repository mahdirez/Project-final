...
export default function Nav() {
  ...
  return (
    <div className="mx-auto">
      ...
      <ul className={`z-10 bg-slate-800 h-full w-2/4 flex flex-col justify-center items-center fixed top-0 left-0 gap-12 ${menu ? "translate-0" : "translate-full"} transition-all duration-500 lg:hidden`} style={{translate : menu ? "0%" : "-100%"}}>
        <li>
          <a href="/">Home</a>
        </li>
        <li>
